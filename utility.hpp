...
#define PROMPT " [#] " // prompt for shell displayed after current working directory
#define SIZE 1000 // maximum size of history

// command history structure
typedef struct _history_state{
    int index; // index of current command being edited
    int size; // size of history
    deque<string> history; // deque to store history of commands
} history_state;
